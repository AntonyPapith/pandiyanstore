...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/product-fixes.css') }}?v={{ filemtime(public_path('css/product-fixes.css')) }}">
</head>
...
<script src="{{ asset('js/product-shine.js') }}?v={{ filemtime(public_path('js/product-shine.js')) }}"></script>
