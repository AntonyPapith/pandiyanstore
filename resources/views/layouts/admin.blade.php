...
<div class="admin-shell">
    <aside class="admin-sidebar" id="adminSidebar">
        ...
        <nav>
            ...
            <a class="{{ request()->routeIs('admin.customers.*') ? 'active' : '' }}" href="{{ route('admin.customers.index') }}"><svg viewBox="0 0 24 24" fill="none"><circle cx="12" cy="8" r="4" stroke="currentColor" stroke-width="1.8"/><path d="M4 21c.8-5 3.5-7 8-7s7.2 2 8 7" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg><span>User Details</span></a>
